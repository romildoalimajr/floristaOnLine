...
<body>
    ...
    <section class="shopping-cart">
        ...
        <div class="box-container">
            ...
            ?>
                    <div class="box">
                        <a href="cart.php?delete=<?php echo $fetch_cart['id']; ?>" class="fas fa-times" onclick="return confirm('deletar do carrinho?');"></a>
                        ...
                        <form action="" method="post">
                            ...
                            <input type="submit" value="atualizar" class="option-btn" name="update_quantity">
                        </form>
        ...
        <div class="cart-total">
            <p>total geral : <span>$<?php echo $grand_total; ?>/-</span></p>
