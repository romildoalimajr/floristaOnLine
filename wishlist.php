...
<section class="heading">
    <h3>sua lista de desejo</h3>
    <p> <a href="home.php">home</a> / lista de desejo </p>
</section>
...
<section class="wishlist">
    ...
    $grand_total += $fetch_wishlist['price'];
        ...
        echo '<p class="empty">sua lista de desejo está vazia</p>';
    }
    ?>
    </div>

    <div class="wishlist-total">
        <p>total geral : <span>R$<?php echo $grand_total; ?>/-</span></p>
